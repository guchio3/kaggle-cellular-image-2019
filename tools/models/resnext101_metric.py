...
class Network(nn.Module):
    def __init__(self, pretrained, n_classes):
        ...
        self.model = torchvision.models.resnext101_32x8d(pretrained=pretrained)
        ...
        with torch.no_grad():
            new_conv.weight[:, :] = torch.stack(
                [torch.mean(self.model.conv1.weight, 1)] * 6, dim=1)
        self.model.conv1 = new_conv
        self.model.fc = myIdentity(in_features=self.model.fc.in_features)
